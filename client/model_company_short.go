...
// CompanyShort struct for CompanyShort
...
func (o *CompanyShort) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o CompanyShort) MarshalJSON() ([]byte, error) {
...
type NullableCompanyShort struct {
	value *CompanyShort
	isSet bool
}

func (v NullableCompanyShort) Get() *CompanyShort {
	return v.value
}

func (v *NullableCompanyShort) Set(val *CompanyShort) {
	v.value = val
	v.isSet = true
}

func (v NullableCompanyShort) IsSet() bool {
	return v.isSet
}

func (v *NullableCompanyShort) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCompanyShort(val *CompanyShort) *NullableCompanyShort {
	return &NullableCompanyShort{value: val, isSet: true}
}

func (v NullableCompanyShort) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCompanyShort) UnmarshalJSON(src []byte) error {
	v.isSet = true
