...
// NameAwardOutcomeDetail struct for NameAwardOutcomeDetail
type NameAwardOutcomeDetail struct {
...
func (o *NameAwardOutcomeDetail) SetPlainTextNil() {
	o.PlainText.Set(nil)
}
...
func (o *NameAwardOutcomeDetail) SetHtmlNil() {
	o.Html.Set(nil)
}
...
func (o NameAwardOutcomeDetail) MarshalJSON() ([]byte, error) {
...
type NullableNameAwardOutcomeDetail struct {
	value *NameAwardOutcomeDetail
	isSet bool
}

func (v NullableNameAwardOutcomeDetail) Get() *NameAwardOutcomeDetail {
	return v.value
}

func (v *NullableNameAwardOutcomeDetail) Set(val *NameAwardOutcomeDetail) {
	v.value = val
	v.isSet = true
}

func (v NullableNameAwardOutcomeDetail) IsSet() bool {
	return v.isSet
}

func (v *NullableNameAwardOutcomeDetail) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNameAwardOutcomeDetail(val *NameAwardOutcomeDetail) *NullableNameAwardOutcomeDetail {
	return &NullableNameAwardOutcomeDetail{value: val, isSet: true}
}

func (v NullableNameAwardOutcomeDetail) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNameAwardOutcomeDetail) UnmarshalJSON(src []byte) error {
	v.isSet = true
